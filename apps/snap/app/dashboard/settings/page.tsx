    ...
    <div className="mx-auto flex max-w-2xl flex-col gap-6">
      ...
      <SettingsForm
        initial={{
          ...
          fontFamily: (JSON.parse(profile.brand || "{}") as { fontFamily?: string }).fontFamily ?? "",
          theme: (JSON.parse(profile.brand || "{}") as { theme?: string }).theme ?? "light",
          tokens: JSON.stringify((JSON.parse(profile.brand || "{}") as { tokens?: unknown }).tokens ?? {}, null, 1),
