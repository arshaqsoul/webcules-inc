 ...
 * The Manual tab fetches /r/wildcode-field.json (the shadcn registry file)
 * so the shown source is always exactly what the CLI would install. */
      ...
      <TabsContent value="cli">
        <div className="space-y-4">
          ...
          <p className="text-xs text-white/40">
            The command installs <code className="font-mono">wildcode-field.tsx</code>,{" "}
            <code className="font-mono">wildcode-field-engine.js</code> and its type
            declarations. No other dependencies — the engine is dependency-free canvas.
          </p>
        </div>
      </TabsContent>
      ...
      <TabsContent value="manual">
        <div className="space-y-5">
          ...
          <div>
            ...
            <CodeBlock
              title="import"
              code={`import WildcodeField from "@/components/wildcode-field";`}
            />
          </div>
