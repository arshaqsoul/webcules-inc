...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  await db.run(sql`CREATE TABLE \`pages\` (
  	...
  	\`published_at\` text,
  	\`application\` text DEFAULT 'webcules',
  	\`slug\` text,
  ...
  await db.run(sql`CREATE TABLE \`_pages_v\` (
  	...
  	\`version_application\` text DEFAULT 'webcules',
  	\`version_slug\` text,
  ...
  await db.run(sql`CREATE TABLE \`background_media\` (
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`alt\` text,
  ...
  await db.run(sql`CREATE TABLE \`background_collections\` (
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`title\` text,
  	\`description\` text,
  ...
  `)
  await db.run(sql`CREATE INDEX \`background_collections_meta_meta_image_idx\` ON \`background_collections\` (\`meta_image_id\`);`)
  await db.run(sql`CREATE INDEX \`background_collections_slug_idx\` ON \`background_collections\` (\`slug\`);`)
  await db.run(sql`CREATE INDEX \`background_collections_updated_at_idx\` ON \`background_collections\` (\`updated_at\`);`)
  await db.run(sql`CREATE INDEX \`background_collections_created_at_idx\` ON \`background_collections\` (\`created_at\`);`)
  await db.run(sql`CREATE INDEX \`background_collections__status_idx\` ON \`background_collections\` (\`_status\`);`)
  await db.run(sql`CREATE TABLE \`background_collections_rels\` (
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`order\` integer,
  	\`parent_id\` integer NOT NULL,
  	\`path\` text NOT NULL,
  	...
  	FOREIGN KEY (\`parent_id\`) REFERENCES \`background_collections\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`media_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`background_media_id\`) REFERENCES \`background_media\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`background_collections_rels_order_idx\` ON \`background_collections_rels\` (\`order\`);`)
  await db.run(sql`CREATE INDEX \`background_collections_rels_parent_idx\` ON \`background_collections_rels\` (\`parent_id\`);`)
  await db.run(sql`CREATE INDEX \`background_collections_rels_path_idx\` ON \`background_collections_rels\` (\`path\`);`)
  await db.run(sql`CREATE INDEX \`background_collections_rels_media_id_idx\` ON \`background_collections_rels\` (\`media_id\`);`)
  await db.run(sql`CREATE INDEX \`background_collections_rels_background_media_id_idx\` ON \`background_collections_rels\` (\`background_media_id\`);`)
  await db.run(sql`CREATE TABLE \`_background_collections_v\` (
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`parent_id\` integer,
  	\`version_title\` text,
  	\`version_description\` text,
  	\`version_midjourney_prompt\` text,
  	\`version_collection_price\` numeric,
  	\`version_status\` text DEFAULT 'draft',
  	\`version_published_at\` text,
  	\`version_is_trending\` integer DEFAULT false,
  	\`version_meta_title\` text,
  	\`version_meta_image_id\` integer,
  	\`version_meta_description\` text,
  	\`version_slug\` text,
  	...
  	\`latest\` integer,
  	\`autosave\` integer,
  	FOREIGN KEY (\`parent_id\`) REFERENCES \`background_collections\`(\`id\`) ON UPDATE no action ON DELETE set null,
  	FOREIGN KEY (\`version_meta_image_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE set null
  );
  `)
  await db.run(sql`CREATE INDEX \`_background_collections_v_parent_idx\` ON \`_background_collections_v\` (\`parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_background_collections_v_version_meta_version_meta_imag_idx\` ON \`_background_collections_v\` (\`version_meta_image_id\`);`)
  await db.run(sql`CREATE INDEX \`_background_collections_v_version_version_slug_idx\` ON \`_background_collections_v\` (\`version_slug\`);`)
  await db.run(sql`CREATE INDEX \`_background_collections_v_version_version_updated_at_idx\` ON \`_background_collections_v\` (\`version_updated_at\`);`)
  await db.run(sql`CREATE INDEX \`_background_collections_v_version_version_created_at_idx\` ON \`_background_collections_v\` (\`version_created_at\`);`)
  await db.run(sql`CREATE INDEX \`_background_collections_v_version_version__status_idx\` ON \`_background_collections_v\` (\`version__status\`);`)
  await db.run(sql`CREATE INDEX \`_background_collections_v_created_at_idx\` ON \`_background_collections_v\` (\`created_at\`);`)
  await db.run(sql`CREATE INDEX \`_background_collections_v_updated_at_idx\` ON \`_background_collections_v\` (\`updated_at\`);`)
  await db.run(sql`CREATE INDEX \`_background_collections_v_latest_idx\` ON \`_background_collections_v\` (\`latest\`);`)
  await db.run(sql`CREATE INDEX \`_background_collections_v_autosave_idx\` ON \`_background_collections_v\` (\`autosave\`);`)
  await db.run(sql`CREATE TABLE \`_background_collections_v_rels\` (
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`order\` integer,
  	\`parent_id\` integer NOT NULL,
  	\`path\` text NOT NULL,
  	\`media_id\` integer,
  	\`background_media_id\` integer,
  	FOREIGN KEY (\`parent_id\`) REFERENCES \`_background_collections_v\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`media_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`background_media_id\`) REFERENCES \`background_media\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`_background_collections_v_rels_order_idx\` ON \`_background_collections_v_rels\` (\`order\`);`)
  await db.run(sql`CREATE INDEX \`_background_collections_v_rels_parent_idx\` ON \`_background_collections_v_rels\` (\`parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_background_collections_v_rels_path_idx\` ON \`_background_collections_v_rels\` (\`path\`);`)
  await db.run(sql`CREATE INDEX \`_background_collections_v_rels_media_id_idx\` ON \`_background_collections_v_rels\` (\`media_id\`);`)
  await db.run(sql`CREATE INDEX \`_background_collections_v_rels_background_media_id_idx\` ON \`_background_collections_v_rels\` (\`background_media_id\`);`)
  await db.run(sql`CREATE TABLE \`purchases\` (
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`user_id\` integer NOT NULL,
  	\`item_type\` text NOT NULL,
  	\`price\` numeric NOT NULL,
  	\`transaction_i_d\` text NOT NULL,
  	\`updated_at\` text DEFAULT (strftime('%Y-%m-%dT%H:%M:%fZ', 'now')) NOT NULL,
  	\`created_at\` text DEFAULT (strftime('%Y-%m-%dT%H:%M:%fZ', 'now')) NOT NULL,
  	FOREIGN KEY (\`user_id\`) REFERENCES \`users\`(\`id\`) ON UPDATE no action ON DELETE set null
  );
  `)
  await db.run(sql`CREATE INDEX \`purchases_user_idx\` ON \`purchases\` (\`user_id\`);`)
  await db.run(sql`CREATE UNIQUE INDEX \`purchases_transaction_i_d_idx\` ON \`purchases\` (\`transaction_i_d\`);`)
  await db.run(sql`CREATE INDEX \`purchases_updated_at_idx\` ON \`purchases\` (\`updated_at\`);`)
  await db.run(sql`CREATE INDEX \`purchases_created_at_idx\` ON \`purchases\` (\`created_at\`);`)
  await db.run(sql`CREATE TABLE \`purchases_rels\` (
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`order\` integer,
  	\`parent_id\` integer NOT NULL,
  	\`path\` text NOT NULL,
  	...
  	\`background_media_id\` integer,
  	FOREIGN KEY (\`parent_id\`) REFERENCES \`purchases\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`background_collections_id\`) REFERENCES \`background_collections\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`background_media_id\`) REFERENCES \`background_media\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`purchases_rels_order_idx\` ON \`purchases_rels\` (\`order\`);`)
  await db.run(sql`CREATE INDEX \`purchases_rels_parent_idx\` ON \`purchases_rels\` (\`parent_id\`);`)
  await db.run(sql`CREATE INDEX \`purchases_rels_path_idx\` ON \`purchases_rels\` (\`path\`);`)
  await db.run(sql`CREATE INDEX \`purchases_rels_background_collections_id_idx\` ON \`purchases_rels\` (\`background_collections_id\`);`)
  await db.run(sql`CREATE INDEX \`purchases_rels_background_media_id_idx\` ON \`purchases_rels\` (\`background_media_id\`);`)
  await db.run(sql`CREATE TABLE \`download_history\` (
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`user_id\` integer NOT NULL,
  	\`item_type\` text NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`download_history_user_idx\` ON \`download_history\` (\`user_id\`);`)
  await db.run(sql`CREATE TABLE \`download_history_rels\` (
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`order\` integer,
  	\`parent_id\` integer NOT NULL,
  	\`path\` text NOT NULL,
  	\`background_collections_id\` integer,
  	\`background_media_id\` integer,
  	FOREIGN KEY (\`parent_id\`) REFERENCES \`download_history\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`background_collections_id\`) REFERENCES \`background_collections\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`background_media_id\`) REFERENCES \`background_media\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`download_history_rels_order_idx\` ON \`download_history_rels\` (\`order\`);`)
  await db.run(sql`CREATE INDEX \`download_history_rels_parent_idx\` ON \`download_history_rels\` (\`parent_id\`);`)
  await db.run(sql`CREATE INDEX \`download_history_rels_path_idx\` ON \`download_history_rels\` (\`path\`);`)
  await db.run(sql`CREATE INDEX \`download_history_rels_background_collections_id_idx\` ON \`download_history_rels\` (\`background_collections_id\`);`)
  await db.run(sql`CREATE INDEX \`download_history_rels_background_media_id_idx\` ON \`download_history_rels\` (\`background_media_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`folders_folder_type\` (
  ...
  `)
  await db.run(sql`CREATE INDEX \`folders_folder_type_order_idx\` ON \`folders_folder_type\` (\`order\`);`)
  await db.run(sql`CREATE INDEX \`folders_folder_type_parent_idx\` ON \`folders_folder_type\` (\`parent_id\`);`)
  ...
  `)
  await db.run(sql`CREATE INDEX \`folders_name_idx\` ON \`folders\` (\`name\`);`)
  await db.run(sql`CREATE INDEX \`folders_folder_idx\` ON \`folders\` (\`folder_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`payload_locked_documents_rels\` (
  	...
  	FOREIGN KEY (\`background_media_id\`) REFERENCES \`background_media\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`background_collections_id\`) REFERENCES \`background_collections\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`purchases_id\`) REFERENCES \`purchases\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`download_history_id\`) REFERENCES \`download_history\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  ...
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_background_media_id_idx\` ON \`payload_locked_documents_rels\` (\`background_media_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_background_collections_id_idx\` ON \`payload_locked_documents_rels\` (\`background_collections_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_purchases_id_idx\` ON \`payload_locked_documents_rels\` (\`purchases_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_download_history_id_idx\` ON \`payload_locked_documents_rels\` (\`download_history_id\`);`)
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  await db.run(sql`DROP TABLE \`background_collections\`;`)
  await db.run(sql`DROP TABLE \`background_collections_rels\`;`)
  await db.run(sql`DROP TABLE \`_background_collections_v\`;`)
  await db.run(sql`DROP TABLE \`_background_collections_v_rels\`;`)
  await db.run(sql`DROP TABLE \`purchases\`;`)
  await db.run(sql`DROP TABLE \`purchases_rels\`;`)
  await db.run(sql`DROP TABLE \`download_history\`;`)
  await db.run(sql`DROP TABLE \`download_history_rels\`;`)
  ...
  await db.run(sql`DROP TABLE \`folders_folder_type\`;`)
